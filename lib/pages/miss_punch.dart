                ...
                children: [
                  ...
                  Positioned.fill(
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          // Header row — horizontal scroll only, no vertical scroll
                    ...
                    ), // SingleChildScrollView header

                          // Body — vertical + horizontal scroll
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              ), // inner SingleChildScrollView (horizontal)
                            ), // outer SingleChildScrollView (vertical)
                          ), // Expanded body
                        ], // Column children
                      ), // outer Column
