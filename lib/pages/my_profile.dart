import 'package:clockwise/services/location_picker.dart';
            ...
            child: Column(
              children: [
                ElevatedButton(onPressed: () async {
                  final LocationResult? result = await LocationPicker.pick(context);
                  if (result != null) {
                    print('Picked Name: ${result.name}');
                    print('Picked Coordinates: ${result.lat}, ${result.lng}');
                  }
